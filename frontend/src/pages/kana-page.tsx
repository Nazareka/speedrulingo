...
import { getKanaAudioBlob, prefetchKanaAudioCatalog } from "../features/kana/audio-cache";
import {
  buildKanaGroupRows,
  ...
  masteryPercent,
} from "../features/kana/model";
import { useContinueKanaLearning, useKanaOverviewQuery } from "../features/kana/queries";
...
export function KanaPage() {
  ...
  const masteredPercent = masteryPercent(overview);
  const groupRows = buildKanaGroupRows(overview);

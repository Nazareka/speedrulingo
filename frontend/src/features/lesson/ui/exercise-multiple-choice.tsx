...
import { FAST_TRANSITION } from "../../../shared/ui/tokens/motion";
import { LESSON_ANSWER_CONTROL } from "../lib/shortcuts";
import { answerStateClasses } from "../model/answer-styles";
import type { MultipleChoiceLessonItem } from "../model/item-helpers";
import { buildTileInstances, stableShuffle } from "../model/tile-helpers";
